...
+ (MBProgressHUD *)showHUDAddedTo:(UIView *)view animated:(BOOL)animated {
    ...
    hud.tag = 111222;
    if (![view viewWithTag:111222] ||
        [view viewWithTag:111222].hidden) {
        [view addSubview:hud];
        [hud show:animated];
    }
...
- (void)layoutSubviews {
	...
	CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:label.font} context:nil].size;
