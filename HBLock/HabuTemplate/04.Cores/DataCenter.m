...
#define kDATA_MODEL_NAME                @"HBLock"
#define kDATA_SQL_NAME                @"HBLock.sqlite"
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[Utils applicationDocumentsDirectory] URLByAppendingPathComponent:kDATA_SQL_NAME];
