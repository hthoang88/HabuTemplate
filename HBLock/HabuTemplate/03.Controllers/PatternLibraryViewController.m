...
@interface PatternLibraryViewController ()<GMGridViewActionDelegate, GMGridViewDataSource, GMGridViewSortingDelegate>
{
...
#define KOLLECTION_MARGIN_KARDS_CELL_LEFT                50
...
@implementation PatternLibraryViewController
...
//    [self loadNavigationBarHasLeftMenu:YES rightMenu:nil];
    // tag grid view
    self.gridView = [[GMGridViewNew alloc] initWithFrame:CGRectMake(0, self.headerView.frame.size.height, self.view.bounds.size.width, self.view.bounds.size.height - self.headerView.frame.size.height)];
