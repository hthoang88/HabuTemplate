...
typedef  void(^SDImageDonwloadPartialProgressBlock)(NSURL *requestURL, UIImage *image, int imageIndex, NSError *error, SDImageCacheType cacheType, BOOL finished);
...
// Additional variable (use for old version)
@property (atomic, retain) NSString                  *scaleOption;
@end

@interface UIImageView (WebCache_Custom)
...
@interface SDWebImageManager (WebCache_Custom)
