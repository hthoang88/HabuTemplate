...
//Hoang
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options webCompleted:(SDWebImageCompletedWithFinishedBlock)completedBlock
{
    ...
    if (url)
    {
        ...
        id<SDWebImageOperation> operation = [SDWebImageManager.sharedManager downloadWithURL:url options:options|SDWebImageLowPriority progress:nil completed:^(NSURL *requestURL, UIImage *image, NSError *error, SDImageCacheType cacheType, BOOL finished)
                                             {
                                                 if (!wself)
                                                     return;
                                                 dispatch_main_sync_safe(^
                                                                         {
                                                                             ...
                                                                             {
                                                                                 completedBlock(requestURL, image, error, cacheType, YES);
                                                                             }
